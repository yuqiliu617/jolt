...
pub fn vector_add_scalar_mul_g1(v: &mut [Bn254G1], generators: &[Bn254G1], scalar: Fr) {
    ...
    let v_inner =
        unsafe { core::slice::from_raw_parts_mut(v.as_mut_ptr().cast::<G1Projective>(), v.len()) };
    // SAFETY: same repr(transparent) guarantee.
    let gens_inner = unsafe {
        core::slice::from_raw_parts(generators.as_ptr().cast::<G1Projective>(), generators.len())
    };
...
pub fn vector_scalar_mul_add_gamma_g1(v: &mut [Bn254G1], scalar: Fr, gamma: &[Bn254G1]) {
    ...
    // SAFETY: same repr(transparent) guarantee.
    let gamma_inner =
        unsafe { core::slice::from_raw_parts(gamma.as_ptr().cast::<G1Projective>(), gamma.len()) };
...
pub fn vector_add_scalar_mul_g2(v: &mut [Bn254G2], generators: &[Bn254G2], scalar: Fr) {
    ...
    let v_inner =
        unsafe { core::slice::from_raw_parts_mut(v.as_mut_ptr().cast::<G2Projective>(), v.len()) };
    // SAFETY: same repr(transparent) guarantee.
    let gens_inner = unsafe {
        core::slice::from_raw_parts(generators.as_ptr().cast::<G2Projective>(), generators.len())
    };
...
pub fn vector_scalar_mul_add_gamma_g2(v: &mut [Bn254G2], scalar: Fr, gamma: &[Bn254G2]) {
    ...
    // SAFETY: same repr(transparent) guarantee.
    let gamma_inner =
        unsafe { core::slice::from_raw_parts(gamma.as_ptr().cast::<G2Projective>(), gamma.len()) };
...
pub fn glv_four_scalar_mul(scalar: Fr, points: &[Bn254G2]) -> Vec<Bn254G2> {
    ...
    let points_inner = unsafe {
        core::slice::from_raw_parts(points.as_ptr().cast::<G2Projective>(), points.len())
    };
