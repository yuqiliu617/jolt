...
pub enum SerializationError {
    // ark_std's no_std io::Error has no core::error::Error impl, so this
    // variant cannot use #[from] source chaining.
    #[error("IO error: {0}")]
...
impl From<ark_std::io::Error> for SerializationError {
